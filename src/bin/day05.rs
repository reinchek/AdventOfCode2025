...
fn main() {
    ...
    println!("#Part 1) How many of the available ingredient IDs are fresh? {}", part_1(&input).0);
...
// ██║     ██║  ██║██║  ██║   ██║        ██║
// ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝        ╚═╝
fn part_1(input: &String) -> (usize, Vec<RangeInclusive<usize>>) {
    ...
    (fresh_available_ids, fresh_ids_flatten)
}
...
fn part_2(input: &String) -> usize {
    let mut fresh_ids_flatten = part_1(&input).1;
    ...
    merged_ranges.iter().map(|range| range.end()+1-range.start()).sum::<usize>()
}

#[test]
fn part1_how_many_available_ingredient_ids_are_fresh(){
    let input = "3-5\n10-14\n16-20\n12-18\n\n1\n5\n8\n11\n17\n32".to_string();
    assert_eq!(part_1(&input).0, 3);
}
#[test]
fn part2_how_many_available_ingredient_ids_are_fresh_according_to_the_fresh_ingredient_id_ranges() {
    let input = "3-5\n10-14\n16-20\n12-18\n\n1\n5\n8\n11\n17\n32".to_string();
